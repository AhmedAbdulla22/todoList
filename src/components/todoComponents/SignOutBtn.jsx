...
const SignOutBtn = ({handleSignOut}) => {
  return (
    <div className="signOut-container border p-1 border-none  rounded-xl text-center absolute right-0 -bottom-10 text-sm hover:[box-shadow:0_0px_10px_0_rgb(0,0,0,0.5)] hover:border ">
